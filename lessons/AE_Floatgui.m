function AE_Floatgui(callbackarg)
    ...
    uicontrol('style','slider','tag','emax','value',emax, ...
        ...
        'callback','AE_Floatgui(1)');
    uicontrol('style','text','string',['L = ' int2str(emin)], ...
        'pos',[0.15 0.35 0.13 0.07],'fontunits','normalized','fontsize',0.7)
    uicontrol('style','text','string',['m = ' int2str(t)], ...
        'pos',[0.435 0.35 0.13 0.07],'fontunits','normalized','fontsize',0.7)
    uicontrol('style','text','string',['U = ' int2str(emax)], ...
